...
const PRESET_COLORS = [
  { colorKey: 'red', value: '#ef4444' },
  { colorKey: 'orange', value: '#f97316' },
  { colorKey: 'amber', value: '#f59e0b' },
  { colorKey: 'emerald', value: '#10b981' },
  { colorKey: 'cyan', value: '#06b6d4' },
  { colorKey: 'blue', value: '#3b82f6' },
  { colorKey: 'violet', value: '#8b5cf6' },
  { colorKey: 'pink', value: '#ec4899' },
] as const;
...
export function TagManager() {
  ...
  const [selectedColor, setSelectedColor] = useState<string>(PRESET_COLORS[3].value);
  ...
  async function handleDelete() {
    ...
    try {
      ...
      setTags((prev) => prev.filter((existing) => existing.id !== tagToDelete.id));
              ...
              <div className="flex gap-1.5">
                {PRESET_COLORS.map((color) => (
                  <button
                    ...
                    aria-label={t('useColor', { color: t(`colors.${color.colorKey}`) })}
