...
const contactFields = [
  { value: 'name', labelKey: 'fieldContactName' },
  { value: 'first_name', labelKey: 'fieldFirstName' },
  { value: 'last_name', labelKey: 'fieldLastName' },
  { value: 'phone', labelKey: 'fieldPhoneNumber' },
  { value: 'email', labelKey: 'fieldEmailAddress' },
  { value: 'company', labelKey: 'fieldCompany' },
];
