...
export function ContactDetailView({
  ...
  async function saveCustomFields() {
    ...
    try {
      ...
      toast.error(t('saveCustomFieldsFailed'));
    }
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              ...
              <TabsContent value="details" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-muted-foreground text-xs">{t('emailLabel')}</Label>
                    <Input
                      value={editEmail}
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-muted-foreground text-xs">{t('companyLabel')}</Label>
                    <Input
                      value={editCompany}
              ...
              <TabsContent value="deals" className="flex-1 overflow-y-auto px-4 py-3">
                {loadingDeals ? (
                  ...
                  <p className="text-xs text-muted-foreground">{t('noDealsYet')}</p>
                ) : (
