...
export const RATE_LIMITS = {
  ...
  /** Message delete (CRM soft-delete + best-effort Meta DELETE call).
   *  Same order of magnitude as `react` — an agent cleaning up a handful
   *  of messages, not a bulk-delete loop. */
  deleteMessage: { limit: 60, windowMs: 60_000 },
