...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
  ...
  out_of_office: {
    ...
    description: 'Responde automaticamente fora do horário de atendimento para ninguém ficar esperando.',
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Obrigado pela sua mensagem! Nossa equipe está offline no momento (9h–18h) e vai responder assim que possível amanhã.",
        },
        parent_index: 0,
        branch: 'yes',
      },
    ...
    steps: [
      {
        ...
        step_config: {
          text:
            "Ótimo — vou te ajudar com os preços! Uma pergunta rápida: quantos usuários você está buscando, aproximadamente?",
        },
      },
      {
        step_type: 'wait',
  ...
  follow_up_reminder: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Só passando para saber — você tem mais alguma dúvida? Estamos à disposição!",
        },
      },
    ],
  },
